                    ...
                    <Grid container spacing={2} alignItems="center" justifyContent="center">
                        <Grid item container spacing={2} sx={{mb: 3}} alignItems="center" justifyContent="center">
                            <Grid item>
                                <img
                                    height="65"
                                    src={(theme.palette.mode === 'light' ? "../../../assets/images/site_landing_light.png" : "../../../assets/images/site_landing_dark.png")}
                                    alt="logo"/>
                            </Grid>
                        </Grid>
                        <Grid item>
                        ...
                        <Grid item>
                            <AuthLogin rememberMe={getState(rememberMe)} loginRequest={loginRequest} dispatch={dispatch} theme={theme}/>
                        </Grid>
                        <Grid item xs={12}>
                            <Divider/>
                        </Grid>
