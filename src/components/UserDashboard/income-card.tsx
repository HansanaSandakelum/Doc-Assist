...
function IncomeCardUser({isLoading, title, count, color, OptionIcon}: any) {
                        ...
                        <List sx={{py: 0}}>
                            <ListItem alignItems="center" disableGutters sx={{py: 0}}>
                                ...
                                <ListItemText
                                    ...
                                    secondary={
                                        <Typography variant="subtitle2" sx={{color: theme.palette.primary.light, mt: 0.25}}>
                                            {title}
                                        </Typography>
                                    }
                                />
